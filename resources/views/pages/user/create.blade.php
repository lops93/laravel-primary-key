<x-app-layout>
    <div class="flex items-center justify-center p-12">
        <div class="w-full max-w-xs">
            <form action="{{ route('users.store') }}" method="POST" class="px-8 pt-6 pb-8 mb-4 bg-white rounded shadow-md dark:bg-slate-800">
                @csrf
                ...
                <button @click="window.location.href = '{{ route('users.index') }}'" type="button" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Cancel</button>
                <button type="submit" class="text-white float-right bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Submit</button>
            </form>
        </div>
    </div>
</x-app-layout>